...
The aim of the project is to provide a dynamic workflow for analyzing STS measurements taken with Nanosurf brand Scanning Tunneling
Microscopes. The code was made to analyze large datasets, especially but not restricted to STS maps. The methods can be applied
